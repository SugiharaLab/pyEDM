...
./CrossMap_ColumnList.py -c V2 V3 V4 V5 -t V1 -E 1 -l 1 500 -p 501 800 -v -P

./CrossMap_Matrix.py -E 5 -v -P
./CrossMap_Matrix.py -i ~/Research/ZebrafishDynamics/data/t_e_v_p_r_l_dFF_100.csv -E 7 -C 5 -P
